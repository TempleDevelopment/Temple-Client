...
import xyz.templecheats.templeclient.Menu.Tools.changeUser;
...
public class TempleMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        // Make "Temple Client" text purple
        drawLogo.drawString(5.0, "\u00a75Temple Client", (float) (this.width / 10 - FontUtils.normal.getStringWidth("Temple Client") / 2),
