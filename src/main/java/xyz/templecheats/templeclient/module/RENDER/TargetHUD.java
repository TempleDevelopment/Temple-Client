...
public class TargetHUD extends Module {
    ...
    public void onRender(RenderGameOverlayEvent e) {
        ...
        if (show && mc.world != null && mc.player != null) {
            ...
            Gui.drawRect((int) (x - 99.0f), (int) (y + 6.0f), (int) (x - 99.0f + this.healthBarWidth), (int) (y + 15.0f), new Color(0x273972).getRGB());

            Gui.drawRect((int) (x - 99.0f), (int) (y + 6.0f), (int) (x - 99.0f + hpWidth), (int) (y + 15.0f), new Color(0x273972).getRGB());

            mc.fontRenderer.drawStringWithShadow(healthStr, x - 138.0f + 46.0f - mc.fontRenderer.getStringWidth(healthStr) / 2.0f, y + 19.5f, -1);
            mc.fontRenderer.drawStringWithShadow("\u2764", x - 138.0f + 46.0f + mc.fontRenderer.getStringWidth(healthStr), y + 19.5f, new Color(0xF80000).getRGB());
