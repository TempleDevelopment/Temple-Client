...
public class TargetHUD extends Module {
    ...
    public TargetHUD() {
        super("TargetHUD","Draws a HUD featuring players name and health when aimed at", Keyboard.KEY_NONE, Category.RENDER);
    }
    ...
    public void onRender(RenderGameOverlayEvent e) {
        ...
        if (show && mc.world != null && mc.player != null) {
            ...
            final float x = scaledWidth / 2.5f;
            ...
            Gui.drawRect((int) (x - 99.0f), (int) (y + 6.0f), (int) (x - 99.0f + this.healthBarWidth), (int) (y + 15.0f), ClickGUI.INSTANCE.getStartColor());
            ...
            mc.fontRenderer.drawStringWithShadow("\u2764", x - 138.0f + 46.0f + mc.fontRenderer.getStringWidth(healthStr), y + 19.5f, ClickGUI.INSTANCE.getStartColor());
