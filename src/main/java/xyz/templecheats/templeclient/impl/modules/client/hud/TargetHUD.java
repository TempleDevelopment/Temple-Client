...
public class TargetHUD extends HUD.HudElement {
    ...
    protected void renderElement(ScaledResolution sr) {
        ...
        if(show && mc.world != null && mc.player != null) {
            ...
            Gui.drawRect((int) (x - 99.0f), (int) (y + 6.0f), (int) (x - 99.0f + healthBarWidth), (int) (y + 15.0f), ClickGUI.INSTANCE.getStartColor());

            Gui.drawRect((int) (x - 99.0f), (int) (y + 6.0f), (int) (x - 99.0f + hpWidth), (int) (y + 15.0f), ClickGUI.INSTANCE.getStartColor());

            FontUtils.drawString(healthStr, x - 138.0f + 46.0f - mc.fontRenderer.getStringWidth(healthStr) / 2.0f, y + 19.5f, -1, true);
            FontUtils.drawString("\u2764", x - 138.0f + 46.0f + mc.fontRenderer.getStringWidth(healthStr), y + 19.5f, ClickGUI.INSTANCE.getStartColor(), true);
            FontUtils.drawString(entity.getName(), x - 97, y - 5.0f, -1, true);
