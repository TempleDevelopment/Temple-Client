...
public class Setting {
	...
	public Setting(String name, Module parent, ArrayList<String> options, String sval) {
		this.name = name;
		this.parent = parent;
	...
	public Setting(String name, Module parent, int red, int green, int blue) {
		this.name = name;
		this.parent = parent;
	...
	public Setting(String name, Module parent, int hexColor) {
		this.name = name;
		this.parent = parent;
