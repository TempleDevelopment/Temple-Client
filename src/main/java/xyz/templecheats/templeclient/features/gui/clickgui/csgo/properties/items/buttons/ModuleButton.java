...
public class ModuleButton extends Button implements IContainer {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (!this.items.isEmpty()) {
            ...
            font20.drawString(this.getLabel(), (float) (x + 5 / 0.8), (float) (y + font20.getFontHeight() - 6.5), module.isEnabled() ? Color.WHITE : new Color(99, 104, 107), false, 1.0f);
            ...
            for (String line : lines) {
                font14.drawString(line, x + 5 / 0.8f, y + font14.getFontHeight() + 9 + yOffset, new Color(99, 104, 107).getRGB(), false, 1.0f);
            ...
            for (int i = 0, index = 0; i < getItems().size(); ) {
                ...
                items.get(i).setLocation(this.x + (float) this.getWidth() / 2 * index + 3, this.y + height + (offsetY - 1));
