...
public abstract class Panel {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawGradientRect(this.x, (float) this.y - 1.5f, this.x + this.width, this.y + this.height - 6, ClickGUI.INSTANCE.getStartColor(), ClickGUI.INSTANCE.getEndColor());
        ...
        if(this.open) {
            RenderUtil.drawRect(this.x, (float) this.y + 12.5f, this.x + this.width, this.open ? (float) (this.y + this.height) + totalItemHeight : (float) (this.y + this.height - 1), 0x77000000);
        }
        FontUtils.drawString(this.getLabel(), (float) this.x + 3.0f, (float) this.y + 1.5f, -1, false);
