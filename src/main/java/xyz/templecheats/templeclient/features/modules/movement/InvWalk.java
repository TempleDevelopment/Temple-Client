...
public class InvWalk extends Module {
    public InvWalk() {
        ...
        TempleClient.instance.settingsManager.rSetting(new Setting("Speed", this, 0.05, 0.01, 0.1, false));
    }
    ...
    public void onClientTick(TickEvent.ClientTickEvent e) {
        ...
        double speed = TempleClient.instance.settingsManager.getSettingByName(this.name, "Speed").getValDouble();
