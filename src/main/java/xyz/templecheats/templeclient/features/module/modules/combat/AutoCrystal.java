...
public class AutoCrystal extends Module {
    ...
    private final DoubleSetting minDmg = new DoubleSetting("Min Damage", this, 0.0, 36.0, 5.0);
    ...
    private final IntSetting armourFacePlace = new IntSetting("Armour Durability %", this, 0, 100, 20);
    private final DoubleSetting minFacePlaceDmg = new DoubleSetting("Min FacePlace Damage", this, 0.0, 10.0, 2.0);
    ...
    private final IntSetting red = new IntSetting("Box Red", this, 0, 255, 255);
    private final IntSetting green = new IntSetting("Box Green", this, 0, 255, 0);
    private final IntSetting blue = new IntSetting("Box Blue", this, 0, 255, 0);
    ...
    public AutoCrystal() {
        ...
        this.registerSettings(instant, antiWeakness, autoSwitch, noGapSwitch, rotate, raytrace, wait, fill, outline, attackSpeed, range, wallRange, enemyRange, minDmg, maxSelfDmg, facePlaceValue, armourFacePlace, minFacePlaceDmg, timeout, maxTargets, red, green, blue, server, crystalPriority);
    }
    ...
    public void onRenderWorld(float partialTicks) {
        if(this.render != null) {
            RenderUtil.blockESP(this.render, this.fill.booleanValue(), this.outline.booleanValue(), true, red.intValue() / 255F, green.intValue() / 255F, blue.intValue() / 255F);
        }
    }
