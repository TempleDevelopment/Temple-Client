...
import xyz.templecheats.templeclient.gui.clickgui.HoverUtils;
...
public class Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GlStateManager.scale(0.65F, 0.65F, 1);
        FontUtils.normal.drawString(!binding ? module.name : "< PRESS KEY >", 0, 0, module.toggled && !binding ? new Color(0x8CA1E0).hashCode() : -1);
